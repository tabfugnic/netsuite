...
describe NetSuite::Records::Employee do
  ...
  it 'has all the right fields' do
    [
      ...
      :job_description, :klass, :labor_cost, :last_modified_date, :last_name,
      :middle_name, :mobile_phone, :next_review_date, :office_phone, :pay_frequency,
      :phone, :phonetic_name, :purchase_order_approval_limit, :purchase_order_approver,
